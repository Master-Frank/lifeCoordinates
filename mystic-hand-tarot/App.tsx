...
import { Loader, PerspectiveCamera, Environment } from '@react-three/drei';
...
const App: React.FC = () => {
  ...
  // Fallback to mouse if camera fails or isn't desired
  ...
  return (
    <TarotProvider>
      <div className="relative w-full h-screen bg-neutral-900 text-white overflow-hidden">
        ...
        {/* Hand Tracking Logic (Invisible/Debug) */}
